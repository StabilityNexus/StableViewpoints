...
/**
 * Render the site footer containing branding, a short description, and social links.
 *
 * The footer includes a headline with gradient text, a descriptive paragraph, and a row
 * of social buttons (Telegram, Discord, LinkedIn, Twitter) that open in new tabs.
 *
 * @returns A React element representing the page footer with branding, descriptive text, and social link buttons.
 */
export default function Footer() {
  return (
    <footer className="border-t border-[#228B22]/10 dark:border-white/10 bg-gradient-to-r from-[#228B22]/5 via-[#91A511]/5 to-[#FFBF00]/5 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 backdrop-blur-sm mt-20 transition-colors">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-6">
            <span className="text-gray-600 dark:text-gray-300 font-medium">Connect with us:</span>
