...
/**
 * Render a clickable card UI for a blog post.
 *
 * Displays the post's image, title, excerpt, and author, and shows a featured badge when `post.featured` is true.
 *
 * @param post - The blog post data to display (expects fields like `slug`, `title`, `author`, `date`, `image`, `excerpt`, `featured`).
 * @returns The rendered blog post card as a React element.
 */
