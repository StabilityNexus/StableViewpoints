      ...
      <main className="max-w-4xl mx-auto px-4 py-8 md:py-12">
        <div className="bg-white shadow-xl overflow-hidden border border-gradient-to-r from-[#228B22]/10 to-[#FFBF00]/10">
          <div className="p-4 sm:p-6 md:p-12">
            {/* Title */}
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold font-playfair bg-gradient-to-r from-[#228B22] via-[#91A511] to-[#E4B905] bg-clip-text text-transparent mb-6 leading-tight pb-2">
              Submit an Article
            </h1>
            ...
            <section className="mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                <FileText className="w-6 h-6 sm:w-8 sm:h-8 text-[#228B22] flex-shrink-0" />
                Topics We Cover
              </h2>
            ...
            {/* How to Submit */}
            <section className="mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">How to Submit an Article</h2>
              <p className="text-gray-700 mb-8 leading-relaxed">
              ...
              {/* Step 1 */}
              <div className="mb-8 p-4 sm:p-6 bg-gradient-to-r from-[#228B22]/5 to-[#91A511]/5 rounded-lg border border-[#228B22]/10">
                <h3 className="text-xl sm:text-2xl font-semibold text-[#228B22] mb-4 flex items-center gap-3">
                  <span className="bg-[#228B22] text-white rounded-full w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center text-base sm:text-lg font-bold flex-shrink-0">
                    1
                  </span>
              ...
              {/* Step 2 */}
              <div className="mb-8 p-4 sm:p-6 bg-gradient-to-r from-[#91A511]/5 to-[#ADAC0D]/5 rounded-lg border border-[#91A511]/10">
                <h3 className="text-xl sm:text-2xl font-semibold text-[#91A511] mb-4 flex items-center gap-3">
                  <span className="bg-[#91A511] text-white rounded-full w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center text-base sm:text-lg font-bold flex-shrink-0">
                    2
                  </span>
                  Format Your Article
                </h3>
...
Remember to cite your sources and provide value to our readers!`}</pre>
              ...
              {/* Step 3 */}
              <div className="mb-8 p-4 sm:p-6 bg-gradient-to-r from-[#ADAC0D]/5 to-[#C8B209]/5 rounded-lg border border-[#ADAC0D]/10">
                <h3 className="text-xl sm:text-2xl font-semibold text-[#ADAC0D] mb-4 flex items-center gap-3">
                  <span className="bg-[#ADAC0D] text-white rounded-full w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center text-base sm:text-lg font-bold flex-shrink-0">
                    3
                  </span>
                ...
                {/* Sub-step 3.1 */}
                <div className="mb-6 p-3 sm:p-4 bg-white/50 rounded-lg border border-[#ADAC0D]/20">
                  <h4 className="text-base sm:text-lg font-semibold text-[#ADAC0D] mb-3 flex items-center gap-2 sm:gap-3">
                    <span className="bg-[#ADAC0D] text-white rounded-full w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center text-xs sm:text-sm font-bold flex-shrink-0">
                      1
                    </span>
                  ...
                  <p className="text-gray-700 break-words">
                    ...
                    <Link
                      ...
                      className="text-[#228B22] hover:underline font-medium break-all"
                    >
                ...
                <div className="mb-6 p-3 sm:p-4 bg-white/50 rounded-lg border border-[#ADAC0D]/20">
                  ...
                  <ul className="text-gray-700 list-disc list-inside space-y-2">
                    <li>
                      In your forked repository, click on <code className="bg-gray-100 px-1 rounded break-all text-sm">public</code>{" "}
                      folder
                    </li>
                    <li>
                      Then click on <code className="bg-gray-100 px-1 rounded break-all text-sm">images</code> folder
                    </li>
                ...
                <div className="mb-6 p-3 sm:p-4 bg-white/50 rounded-lg border border-[#ADAC0D]/20">
                  ...
                  <ul className="text-gray-700 list-disc list-inside space-y-2">
                    <li>
                      Navigate to <code className="bg-gray-100 px-1 rounded break-all text-sm">public</code> →{" "}
                      <code className="bg-gray-100 px-1 rounded break-all text-sm">articles</code> folder
                    </li>
                    <li>Click "Add file" → "Create new file"</li>
                    <li>
                      Name your file: <code className="bg-gray-100 px-1 rounded break-all text-sm">your-article-title.md</code> (use
                ...
                <div className="mb-6 p-3 sm:p-4 bg-white/50 rounded-lg border border-[#ADAC0D]/20">
                  ...
                  <ul className="text-gray-700 list-disc list-inside space-y-2">
                    <li>
                      ...
                      <code className="bg-gray-100 px-1 rounded break-all text-sm">image: "/images/your-header-image.jpg"</code>
                    </li>
                    <li>
                      <strong>Inline images</strong>: Use markdown syntax{" "}
                      <code className="bg-gray-100 px-1 rounded break-all text-sm">![Description](/images/your-image.jpg)</code>
                    </li>
                    <li>
                      <strong>Image paths</strong>: Always start with{" "}
                      <code className="bg-gray-100 px-1 rounded break-all text-sm">/images/</code> (e.g.,{" "}
                      <code className="bg-gray-100 px-1 rounded break-all text-sm">/images/defi-protocol-diagram.png</code>)
                    </li>
                  </ul>
                </div>
              ...
              {/* Step 4 - Add to Index */}
              <div className="mb-8 p-4 sm:p-6 bg-gradient-to-r from-[#C8B209]/5 to-[#E4B905]/5 rounded-lg border border-[#C8B209]/10">
                <h3 className="text-xl sm:text-2xl font-semibold text-[#C8B209] mb-4 flex items-center gap-3">
                  <span className="bg-[#C8B209] text-white rounded-full w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center text-base sm:text-lg font-bold flex-shrink-0">
                    4
                  </span>
                ...
                {/* Sub-step 4.1 */}
                <div className="mb-6 p-3 sm:p-4 bg-white/50 rounded-lg border border-[#C8B209]/20">
                  <h4 className="text-base sm:text-lg font-semibold text-[#C8B209] mb-3 flex items-center gap-2 sm:gap-3">
                    <span className="bg-[#C8B209] text-white rounded-full w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center text-xs sm:text-sm font-bold flex-shrink-0">
                      1
                    </span>
                    Navigate to the articles index
                  </h4>
                  <p className="text-gray-700">
                    Go to <code className="bg-gray-100 px-1 rounded break-all text-sm">public</code> →{" "}
                    <code className="bg-gray-100 px-1 rounded break-all text-sm">articles</code> folder, then click on{" "}
                    <code className="bg-gray-100 px-1 rounded break-all text-sm">articles-index.json</code>
                  </p>
                </div>
                ...
                <div className="mb-6 p-3 sm:p-4 bg-white/50 rounded-lg border border-[#C8B209]/20">
                  ...
                  <p className="text-gray-700">
                    ...
                    <code className="bg-gray-100 px-1 rounded break-all text-sm">articles</code> array at the top (it will appear first on
                    the website)
                  </p>
                </div>
  ...
  "featured": false
                ...
                <div className="mb-6 p-3 sm:p-4 bg-white/50 rounded-lg border border-[#C8B209]/20">
                  ...
                  <ul className="text-gray-700 list-disc list-inside space-y-2">
                    ...
                    <li>
                      ...
                      <code className="bg-gray-100 px-1 rounded break-all text-sm">"featured": true</code> if you want your article
              ...
              <div className="mb-8 p-4 sm:p-6 bg-gradient-to-r from-[#E4B905]/5 to-[#FFBF00]/5 rounded-lg border border-[#E4B905]/10">
                <h3 className="text-xl sm:text-2xl font-semibold text-[#E4B905] mb-4 flex items-center gap-3">
                  <span className="bg-[#E4B905] text-white rounded-full w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center text-base sm:text-lg font-bold flex-shrink-0">
                    5
                  </span>
                ...
                {/* Sub-step 5.1 */}
                <div className="mb-6 p-3 sm:p-4 bg-white/50 rounded-lg border border-[#E4B905]/20">
                  <h4 className="text-base sm:text-lg font-semibold text-[#E4B905] mb-3 flex items-center gap-2 sm:gap-3">
                    <span className="bg-[#E4B905] text-white rounded-full w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center text-xs sm:text-sm font-bold flex-shrink-0">
                      1
                    </span>
              ...
              <div className="mb-8 p-4 sm:p-6 bg-gradient-to-r from-[#FFBF00]/5 to-[#FFC517]/5 rounded-lg border border-[#FFBF00]/10">
                <h3 className="text-xl sm:text-2xl font-semibold text-[#FFBF00] mb-4 flex items-center gap-3">
                  <span className="bg-[#FFBF00] text-white rounded-full w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center text-base sm:text-lg font-bold flex-shrink-0">
                    6
                  </span>
                  Review Process
                </h3>
            ...
            <section className="mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                <ImageIcon className="w-6 h-6 sm:w-8 sm:h-8 text-[#228B22] flex-shrink-0" />
                Image Guidelines
              </h2>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                <div className="bg-gradient-to-r from-[#228B22]/5 to-[#91A511]/5 p-4 sm:p-6 rounded-lg border border-[#228B22]/10">
                  <h3 className="text-lg sm:text-xl font-semibold text-[#228B22] mb-4">Technical Requirements</h3>
                ...
                <div className="bg-gradient-to-r from-[#91A511]/5 to-[#ADAC0D]/5 p-4 sm:p-6 rounded-lg border border-[#91A511]/10">
                  <h3 className="text-lg sm:text-xl font-semibold text-[#91A511] mb-4">Content Guidelines</h3>
                  <ul className="text-gray-700 space-y-2">
                    <li>
              ...
              <div className="mt-4 sm:mt-6 p-4 sm:p-6 bg-gradient-to-r from-[#ADAC0D]/5 to-[#C8B209]/5 rounded-lg border border-[#ADAC0D]/10">
                <h3 className="text-lg sm:text-xl font-semibold text-[#ADAC0D] mb-4">Naming Convention</h3>
                <ul className="text-gray-700 space-y-2">
                  <li>Use descriptive, lowercase names with hyphens</li>
                  <li>
                    <strong>Examples</strong>:{" "}
                    <code className="bg-gray-100 px-1 rounded break-all text-sm">blockchain-network-diagram.jpg</code>,{" "}
                    <code className="bg-gray-100 px-1 rounded break-all text-sm">defi-yield-comparison.png</code>
                  </li>
                  <li>
                    Avoid spaces, special characters, or generic names like{" "}
                    <code className="bg-gray-100 px-1 rounded break-all text-sm">image1.jpg</code>
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section className="mb-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">Submission Guidelines</h2>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                <div className="bg-gradient-to-r from-[#E4B905]/5 to-[#FFBF00]/5 p-4 sm:p-6 rounded-lg border border-[#E4B905]/10">
                  <h3 className="text-lg sm:text-xl font-semibold text-[#E4B905] mb-4">Content Standards</h3>
                  <ul className="text-gray-700 space-y-2">
                    <li>
                ...
                <div className="bg-gradient-to-r from-[#FFBF00]/5 to-[#FFC517]/5 p-4 sm:p-6 rounded-lg border border-[#FFBF00]/10">
                  <h3 className="text-lg sm:text-xl font-semibold text-[#FFBF00] mb-4">Technical Requirements</h3>
                  <ul className="text-gray-700 space-y-2">
                    <li>
            ...
            <section className="mb-8">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">Questions?</h2>
