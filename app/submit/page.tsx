...
/**
 * Render the article submission guide page for Stable Viewpoints.
 *
 * The component returns the full submission UI, including a sticky header with navigation and theme toggle,
 * a main content card detailing topics, step-by-step submission instructions, image and submission guidelines,
 * contact links, and the site footer. The layout includes responsive styling and dark-mode aware color variants.
 *
 * @returns A JSX element containing the complete submission guide page layout.
 */
export default function SubmitPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-yellow-50 to-[#FFC517]/10 dark:from-slate-950 dark:via-emerald-950 dark:to-slate-900 transition-colors text-gray-900 dark:text-gray-100">
      {/* Header */}
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white dark:bg-slate-950/50 shadow-xl overflow-hidden border border-[#228B22]/10 dark:border-white/10 transition-colors">
          <div className="p-8 md:p-12">
            ...
            <section className="mb-12">
              ...
              <div className="mb-8 p-6 bg-gradient-to-r from-[#91A511]/5 to-[#ADAC0D]/5 rounded-lg border border-[#91A511]/10">
                ...
                <p className="text-gray-700 dark:text-gray-200 mb-4">Create a file with this structure:</p>
...
Remember to cite your sources and provide value to our readers!`}</pre>
              ...
              <div className="mb-8 p-6 bg-gradient-to-r from-[#ADAC0D]/5 to-[#C8B209]/5 rounded-lg border border-[#ADAC0D]/10">
                ...
                {/* Sub-step 3.1 */}
                <div className="mb-6 p-4 bg-white/50 dark:bg-slate-900/40 rounded-lg border border-[#ADAC0D]/20">
              ...
              <div className="mb-8 p-6 bg-gradient-to-r from-[#C8B209]/5 to-[#E4B905]/5 rounded-lg border border-[#C8B209]/10">
                ...
                {/* Sub-step 4.1 */}
                <div className="mb-6 p-4 bg-white/50 dark:bg-slate-900/40 rounded-lg border border-[#C8B209]/20">
  ...
  "featured": false
              ...
              <div className="mb-8 p-6 bg-gradient-to-r from-[#E4B905]/5 to-[#FFBF00]/5 rounded-lg border border-[#E4B905]/10">
                ...
                {/* Sub-step 5.1 */}
                <div className="mb-6 p-4 bg-white/50 dark:bg-slate-900/40 rounded-lg border border-[#E4B905]/20">
